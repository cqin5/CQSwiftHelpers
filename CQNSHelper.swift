...
extension CQHelper {
    ...
    class func NSAttributedStringMake(string string:String, font:UIFont, colour:UIColor) -> NSAttributedString {
        
        return NSAttributedString(string: string, attributes: [NSFontAttributeName : font, NSForegroundColorAttributeName : colour])
        
    }
    
    class func NSMutableAttributedStringMake(string string:String, font:UIFont, colour:UIColor) -> NSMutableAttributedString {
